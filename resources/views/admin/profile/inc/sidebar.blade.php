...
<div class="card" style="width: 18rem;">
    ...
    <ul class="list-group list-group-flush">
        ...
        <a href="{{ route('admin-image') }}" class="btn btn-sm btn-block btn-primary">Update Image</a>
        <a href="{{ route('admin-password') }}" class="btn btn-sm btn-block btn-primary">Update Password</a>
